...
import (
	...
	"github.com/codecodeorg/arbgeth/crypto/signify"
	"github.com/codecodeorg/arbgeth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/codecodeorg/arbgeth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/codecodeorg/arbgeth/internal/version.gitDate="+env.Date)
	}
